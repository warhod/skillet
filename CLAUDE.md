...
This project uses Skillet for consistent code quality and development standards.
...
For example:
- For code quality and development guidelines, read: .skillet/skills/git-os/SKILL.md
- For ticket automation, read: .skillet/skills/sprint/SKILL.md
- For deployment verification, read: .skillet/skills/deploy-checklist/SKILL.md